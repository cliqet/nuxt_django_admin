...
const { getModelAdminSettings, getModelFields } = useAdminApiRequests();
...
const modelAdminSettingsResponse = await getModelAdminSettings(appName.value!, modelName.value!);
const modelAdminSettings: ModelAdminSettingsType = modelAdminSettingsResponse.model_admin_settings;

const modelFieldsResponse = await getModelFields(appName.value!, modelName.value!);
